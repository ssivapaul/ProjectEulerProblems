...
console.time("Prime")
console.log(primePowerTriples(50)) //should return 4.
console.log(primePowerTriples(10035)) //should return 684.
console.log(primePowerTriples(500000)) //should return 18899.
console.log(primePowerTriples(5000000)) //should return 138932.
console.log(primePowerTriples(50000000)) //should return 1097343.
